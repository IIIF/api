...
namespaces = {'ore' : Namespace('http://www.openarchives.org/ore/terms/'),
              ...
              'old_sc' : Namespace('http://www.shared-canvas.org/ns/'),
              'old_cnt' : Namespace('http://www.w3.org/2008/content#'),
              'old_oac' : Namespace('http://www.openannotation.org/ns/')
                            
              # Less useful ones
#              'doap' : Namespace("http://usefulinc.com/ns/doap#"),
#              'cal' : Namespace('http://www.w3.org/2002/12/cal/icaltzd#'),
