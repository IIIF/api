...
[image-stable-version]: {{ site.url }}{{ site.baseurl }}/api/image/{{ site.image_api.latest.major }}.{{ site.image_api.latest.minor }}/ "Latest Image API Stable Version"
[image-compliance-stable-version]: {{ site.url }}{{ site.baseurl }}/api/image/{{ site.image_api.latest.major }}.{{ site.image_api.latest.minor }}/ "Latest Image API Compliance Stable Version"
...
[image3-compliance-levels]: {{ site.url }}{{ site.baseurl }}/api/image/3.{{ site.image_api.latest.minor }}/#compliance-level-and-profile-document "6. Compliance Level and Profile Document"
