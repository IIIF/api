...
*   A Feature has a `geometry` property where the value of the property _MUST_ be either a Geometry object as defined in [2.2.4 Geometry Objects and Position](#224-geometry-objects-and-position) or, in the case that the Feature is unlocated, a JSON null value.
...
* A Geometry object has a `type` property with a value from the [Table of Geometry Types](#table-of-geometry-types) in this section.
