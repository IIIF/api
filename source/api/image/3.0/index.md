...
The term **full image** is used to refer to the entire area of the underlying image content, with the pixel dimensions given in the [image information][image3-information] document, and which is imagined as the starting point for [image requests][image-requests].
