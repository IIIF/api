...
| `viewing_hint` | Optional | A hint to the intended use of the size.  The following values are defined by this specification: `icon`, `thumbnail`, `xx-small`, `x-small`, `small`, `medium`, `large`, `x-large`, `xx-large`, `full`. If other values are given, they _MUST_ be URIs. |
{: .image-api-table}
