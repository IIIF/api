...
## Abstract
{:.no_toc}
This is one of a number of [IIIF registries][registry-home]. It lists a set of types for external resources that have been identified as useful for implementations, across the APIs.  They may be defined by the IIIF community, or outside of it.
