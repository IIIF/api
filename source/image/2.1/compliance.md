...
[image-api]: {{ site.api_url | absolute_url }}/image/{{ page.major }}.{{ page.minor }}/ "Image API {{ page.major }}.{{ page.minor }}"
...
[size]: #size "3.2 Size"
[profile]: {{ site.api_url | absolute_url }}/image/{{ page.major }}.{{ page.minor }}/#profile-description "5.3 Profile Description"
[stable-version]: {{ site.api_url | absolute_url }}/image/{{ site.data.apis.image.latest.major }}.{{ site.data.apis.image.latest.minor }}/compliance/ "Stable Version"
[full-dep]: {{ site.api_url | absolute_url }}/image/2.{{ page.minor }}/#full-dep "Full Size Keyword Deprecation Warning"
