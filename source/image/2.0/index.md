...
[change-log11]: {{ site.api_url | absolute_url }}/image/1.1/change-log/ "Change Log for Version 1.1"
[change-log]: {{ site.api_url | absolute_url }}/image/2.0/change-log/ "Change Log for Version 2.0"
[compliance]: {{ site.api_url | absolute_url }}/image/2.0/compliance/ "Image API Compliance"
[compliance-quality]: {{ site.api_url | absolute_url }}/image/2.0/compliance/#quality "Image API Compliance: Quality"
...
[apache-notes-conditional-content-type]: {{ site.api_url | absolute_url }}/annex/notes/apache/#conditional-content-types "Apache HTTP Server Implementation Notes: Conditional Content Types"
[apache-notes-set-compliance-link-header]: {{ site.api_url | absolute_url }}/annex/notes/apache/#set-compliance-link-header "Apache HTTP Server Implementation Notes: Set Compliance Link Header"
...
[prev-version]: {{ site.api_url | absolute_url }}/image/1.1/ "Previous Version"
